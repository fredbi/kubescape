...
// WithReportURL specifies the URL to post reports (currently unused).
...
// WithUIURL specifies the URL to access the KS Cloud UI (currently unused).
func WithUIURL(u string) KSCloudOption {
	return func(o *ksCloudOptions) {
		o.cloudUIURL = u
	}
}
